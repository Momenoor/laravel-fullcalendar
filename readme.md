...
```php
<?php
class CalendarEvent extends \Illuminate\Database\Eloquent\Model implements \Momenoor\LaravelFullcalendar\Event
{
	//...
...
$eloquentEvent = EventModel::first(); //EventModel implements Momenoor\LaravelFullcalendar\Event
...
<head>
    ...
    <script src="//cdn.jsdelivr.net/npm/fullcalendar@5.11.0/main.min.js"></script>
